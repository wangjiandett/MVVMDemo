package com.dett.dettmvvm.exception;

import android.content.Context;

import com.dett.dettmvvm.DettMvvm;
import com.dett.dettmvvm.R;
...
public class ExceptionHandle {
    ...
    public static ResponseException handleException(Throwable e) {
        ...
        Context context = DettMvvm.getInstance().getContext();
        if (e instanceof HttpException) {
            ...
            switch (exception.code()) {
                ...
                default:
                    ex.message = context.getString(R.string.tt_error_net, exception.code());
                    break;
            }
            return ex;
        }
