...
/**
 * 文件上传，返回响应实体Resp中如果没有Data实体，或想直接处理Resp，可以设置Data实体为Resp<p>
 *
 * Created by：wangjian on 2017/12/21 11:00
 * @param <Resp> 请求响应实体
 * @param <Data> 请求响应实体中的data实体<p>
 */
public abstract class BaseUploadFileModel<Resp, Data> extends BaseModel<Resp, Data> implements ProgressResultListener {
